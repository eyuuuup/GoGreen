...
public final class Transport {
     ...
     */
    public static void addCycleAction(int distance, String description) throws ConnectIOException {
     ...
     */
    public static void addCarAction(int distance, String description) throws ConnectIOException {
     ...
     * Next to this the method calculates the CO2 reduction using Brighter planet.
     */
    public static void addPlaneAction(int distance, String description) throws ConnectIOException {
        ...
        ComCached.addAction("Plane", (15000 - distance) / 100, carbonReduced, carbonPlane, description);
    }
     ...
     * Next to this the method calculates the CO2 reduction using Brighter planet.
     */
    public static void addPublicTransportAction(int distance, String description) throws ConnectIOException {
